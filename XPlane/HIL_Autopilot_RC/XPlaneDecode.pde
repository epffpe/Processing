class XPlaneDecode {
  ...
  public byte[] autopilotmensaje() {
    ...
    variable = xplane.float2byte(cntThrottle);
    ...
    mensaje[60] = (byte)0x55;
    mensaje[61] = (byte)0x55;
    mensaje[62] = (byte)0x55;
    mensaje[63] = (byte)0x55;
    return mensaje;
  }
  
   public byte[] Joystickmensaje(float elevator, float aleron, float rudder, float gases) {
    byte[] mensaje = new byte[24];
    ...
    mensaje[6] = variable[2];
    mensaje[7] = variable[3];
    variable = xplane.float2byte(aleron);
    mensaje[8] = variable[0];
    mensaje[9] = variable[1];
    mensaje[10] = variable[2];
    mensaje[11] = variable[3];
    variable = xplane.float2byte(rudder);
    mensaje[12] = variable[0];
    mensaje[13] = variable[1];
    mensaje[14] = variable[2];
    mensaje[15] = variable[3];
    variable = xplane.float2byte(gases);
    mensaje[16] = variable[0];
    mensaje[17] = variable[1];
    mensaje[18] = variable[2];
    mensaje[19] = variable[3];
    
    mensaje[20] = (byte)0x55;
    mensaje[21] = (byte)0x55;
    mensaje[22] = (byte)0x55;
    mensaje[23] = (byte)0x55;
    return mensaje;
  }
  
  public byte[] Joystickmensaje() {
    byte[] mensaje = new byte[24];
  ...
  public byte[] Mapsmensaje() {
    float altitud = alt_ftmsl() * 0.3048;
    float yaw = hding_true();
    float pitch = pitch_deg();
    float roll = roll_deg();
    float latitud = lat_deg();
    float longitud = long_deg();
    ...
    String alturastr = String.valueOf(altitud);
    String yawstr = String.valueOf(yaw);
    String pitchstr = String.valueOf(pitch);
    String rollstr = String.valueOf(roll);
    
    String mensaje = longitudstr + ',' + latitudstr + ',' + alturastr + ',' + yawstr + ',' + pitchstr + ',' + rollstr;
    //println(mensaje);
